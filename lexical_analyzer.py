...
class State():
	def __init__(self, label, is_final = False, action = None):
		self.label = label
...
if __name__ == "__main__":
					...
					token_dict["*"] = '042'
					token_dict["+"] = '043'
					token_dict["identificador"] = '(097|098)((097|098)|(048|049|050|051|052|053|054|055|056|057))*'
					token_dict["letra"] = '(097|098)'
